...
```{r multiqc_raw, results='asis', echo=FALSE}
# Specify the path to your shell script file
script_path <- "workflow/scripts/multiqc_raw.sh"
...
```{r multiqc_trim, results='asis', echo=FALSE}
# Specify the path to your shell script file
script_path <- "workflow/scripts/multiqc_trim.sh"
...
```{r multiqc_decontam, results='asis', echo=FALSE}
# Specify the path to your shell script file
script_path <- "workflow/scripts/multiqc_decontam.sh"
